package es.upm.miw.pd.ecp2.composite.expresion;
import static org.junit.Assert.assertEquals;

import org.junit.Before;
import org.junit.Test;

import es.upm.miw.pd.ecp2.composite.expression.Dividir;
import es.upm.miw.pd.ecp2.composite.expression.Expresion;
import es.upm.miw.pd.ecp2.composite.expression.Multiplicar;
import es.upm.miw.pd.ecp2.composite.expression.Numero;
import es.upm.miw.pd.ecp2.composite.expression.Restar;
import es.upm.miw.pd.ecp2.composite.expression.Sumar;
